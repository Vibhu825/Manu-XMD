...
SESSION_ID: process.env.SESSION_ID === undefined ? 'Manu-MD&ZyQ0BjdB' : process.env.SESSION_ID, // put your session id || ඔයාගෙ සෙසන් එක දාන්න...😌❤
...
SUDO: process.env.SUDO === undefined ? '94721931393' : process.env.SUDO,
